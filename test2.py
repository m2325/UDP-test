...
def udp_send(data, dest_addr, src_addr=('192.168.6.104', 8080)):
...
if __name__ == '__main__':
    udp_send("hellohellohellohellohellohello",('192.168.6.121', 2368)) 
    udp_recv(('192.168.6.104', 2368), 60)
